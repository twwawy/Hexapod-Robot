#!/usr/bin/env python3
"""Build the primitive-collision staircase scene used for MJX training."""
...
STEP_DEPTH = 0.25
STEP_COUNT = 7
STAIR_TOTAL_RISE = 0.20
STEP_HEIGHT = STAIR_TOTAL_RISE / STEP_COUNT
...
def prepare_rl_scene(output: Path = RL_SCENE_OUTPUT) -> Path:
    ...
    root = tree.getroot()
    root.set("model", "hexapod_stairs_rl")
