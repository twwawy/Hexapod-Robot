...
`codex/adaptive-hybrid-rl-integration`의 개발 내용을 `main`에 통합했다.
STM32 기본 SPI 통신은 기존 **64바이트 센서·GPS 형식**을 유지한다.
128바이트 강화학습 통신은 별도 활성화가 필요하다. [통신 형식](docs/ADAPTIVE_SPI_V3.md).
