...
const RobotCalibration_t g_robot_calibration =
{
    ...
    .pressure =
    {
        {12U, 6U, true, true},  // 다리 1의 10% 접촉·5% 해제값을 저장한다.
        {17U, 8U, true, true},  // 다리 2의 10% 접촉·5% 해제값을 저장한다.
        {17U, 8U, true, true},  // 다리 3의 10% 접촉·5% 해제값을 저장한다.
        {16U, 8U, true, true},  // 다리 4의 10% 접촉·5% 해제값을 저장한다.
        {15U, 7U, true, true},  // 다리 5의 10% 접촉·5% 해제값을 저장한다.
        { 9U, 4U, true, true}   // 다리 6의 10% 접촉·5% 해제값을 저장한다.
    },
