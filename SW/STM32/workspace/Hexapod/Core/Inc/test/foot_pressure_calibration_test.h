#ifndef FOOT_PRESSURE_CALIBRATION_TEST_H
#define FOOT_PRESSURE_CALIBRATION_TEST_H
...
} FootPressureCalibrationTest_t;

void FootPressureCalibrationTest_Init(FootPressureCalibrationTest_t *test);  // 압력 표본 누적을 초기화한다.
